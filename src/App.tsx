    ...
    <div className="min-h-screen bg-[#050505] text-gray-100 overflow-x-hidden selection:bg-[#D4AF37] selection:text-black font-sans relative">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center space-y-4 max-w-sm mx-auto">
          ...
          {/* Re-established beautiful smartphone format 9:16 vertical video player wrapper */}
          <div className="w-full max-w-[310px] sm:max-w-[340px] aspect-[9/16] bg-black rounded-[32px] border-[6px] border-[#1a1a1a] shadow-[0_40px_80px_rgba(0,0,0,0.8),0_0_25px_rgba(212,175,55,0.15)] relative overflow-hidden group/phone ring-1 ring-white/10">
